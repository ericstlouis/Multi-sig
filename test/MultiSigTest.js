...
describe("intialized MultiSig", function () {
  ...
  it("sign typed data", async function() {
    ...
    const signature1 = new Array(await signer1._signTypedData(domain, types, value));
    const signature2 = new Array(await signer2._signTypedData(domain, types, value));
    const signature3 = new Array(await signer3._signTypedData(domain, types, value));
